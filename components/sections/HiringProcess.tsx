...
export default function HiringProcess() {
  return (
    <section className="relative py-28 bg-[#05080F] border-t border-white/[0.06] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            {SITE_DATA.hiringSteps.map((step) => (
              <div
                key={step.step}
                className="glass-card p-8 flex flex-col items-center text-center relative group hover:border-[#00E599]/50 transition duration-300"
              >
                {/* Step Number Circle */}
